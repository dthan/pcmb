		 ...
		 <script language="javascript" type="text/javascript" src="js/user.js"></script>	
                ...
                <fieldset>
                    <dl>
                        ...
                        <dd><input type="text" name="username" id="username" size="68" value="<?php echo "$r[username]"; ?>"/>
						<input type="hidden" name="id" id="id" size="68" value="<?php echo "$r[id_user]"; ?>"/>
					...
					<dl>
                        ...
                        <dd><input type="text" name="email" id="email" size="68" value="<?php echo "$r[email]"; ?>" /></dd>
					...
					<dl>
                        ...
                        <dd><input type="text" name="website" id="website" size="68" value="<?php echo "$r[web]"; ?>"/></dd>
						<dd>
                    ...
                    <dl>
                        ...
                        <dd><input type="file" name="upload" id="upload" /><img src="../foto_user/<?php echo "$r[photo]"; ?>" width="100">
						<div id="web" style=" color : blue;"><em>* kosongkan jika tidak ada foto yang di upload</em></div></dd>
                    </dl>
